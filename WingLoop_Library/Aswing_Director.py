...
class Aswing_Director:
    ...
    def Load_Files_ASW(self, filename):
        ...
        if filename.endswith(".asw"):
            stdout, stderr = self.send_command_and_receive("load " + filename)
        elif filename.endswith(".pnt"):
            stdout, stderr = self.send_command_and_receive("pget " + filename)
        elif filename.endswith(".set"):
            stdout, stderr = self.send_command_and_receive("sget " + filename)
        elif filename.endswith(".state"):
            stdout, stderr = self.send_command_and_receive("tget " + filename)
        elif filename.endswith(".gust"):
            stdout, stderr = self.send_command_and_receive("gget " + filename)
        else:
